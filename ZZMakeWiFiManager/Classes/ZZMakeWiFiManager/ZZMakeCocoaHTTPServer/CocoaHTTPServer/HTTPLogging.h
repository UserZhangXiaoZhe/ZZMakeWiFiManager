...
/*
 报Implicit declaration of function 'LOG_OBJC_MAYBE' is invalid in C99错误
 步骤1：
 在文件HTTPLogging.h中将#import“ DDLog.h”更改为#import <CocoaLumberjack/CocoaLumberjack.h>
  或者#import "CocoaLumberjack.h"
 */
...
报Implicit declaration of function 'LOG_OBJC_MAYBE' is invalid in C99错误
第三步：
将HTTPLogging.h文件中的所有LOG_OBJC_MAYBE替换为HTTP_LOG_OBJC_MAYBE，
 并将所有LOG_C_MAYBE替换为HTTP_LOG_C_MAYBE
*/
